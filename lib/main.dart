        ...
        children: <Widget>[
          Expanded(child: Container(child: Row(
            ...
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                Text('Player O',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 20,color: Colors.white)),
                Text(
                  oScore.toString(),
            ...
            Expanded(
              ...
              return GestureDetector(
                ...
                child: Center(child: Text(displayElement[index],
            ...
            Expanded(child: Container(
              child: Row(
                ...
                children: <Widget>[
                  ElevatedButton(
                    onPressed: _clearScoreBoard, child: Text("Clear Score Board"),)
                ],
              ),
            ))
        ],
